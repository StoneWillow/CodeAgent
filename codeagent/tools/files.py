...
def register_file_tools(registry: ToolRegistry, ws: Workspace, *, readonly: bool = False) -> None:
    @registry.tool
...
def register_explore_tools(registry: ToolRegistry, ws: Workspace) -> None:
    """Read-only file tools for sub-agents."""
    register_file_tools(registry, ws, readonly=True)
